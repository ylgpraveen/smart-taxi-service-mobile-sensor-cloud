...
public class Charts extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(SensorDetailsVO v : ls){
			...
			int averageSpeed = ThreadLocalRandom.current().nextInt(0, 151);
			sensorDetail.add(10,Integer.toString(averageSpeed));
			int temperature =  ThreadLocalRandom.current().nextInt(0, 45 );
			sensorDetail.add(11,Integer.toString(temperature));
			int pressure =  ThreadLocalRandom.current().nextInt(28,36);
			sensorDetail.add(12,Integer.toString(pressure));
